...
import { SelectTilesetDlg } from "./select-tileset";
import { SaveTilesetDlg } from "./save-tileset";
import { NewTilesetDlg } from "./new-tileset";
import { EditTileDlg } from "./edit-tile";
...
export class EditTilesetDlg {
    ...
    constructor(public controller: DialogController, public dialogService: DialogService, public router: Router, 
    ...
    attached() {
        ...
        this.subscribers = [];
        this.subscribers.push(this.eventChannel.subscribe("create-new-tileset", data => this.openNewTilesetDlg()));
